...
# K-fuscator Jarz | Project
# Author  : JarzTunnel
# Github  : https://github.com/Salampahah
...
def about():
    ...
    print(f"{cyan}[Author]    {purple} :[JarzTunnel]")
    print(f"{cyan}[Github]    {purple} :[https://github.com/salampahah]")
    print(f"{cyan}[Messenger] {purple} :[https://wa.me/6285279323958]")
...
# Custom path chooser
def mover(out_file):
    move= input(ask+"Pilih n Lalu Enter ( n ) > "+green)
    if move=="y":
...
def encryptsh():
    ...
    with open(".temp",'r') as temp_f, open(out_file,'w') as out_f:
        ...
        out_f.write("# Encrypted by Jarz | FUSCATOR\n# Github- https://github.com/salampahah\n\n"+filedata)
    os.remove(".temp")
...
def decryptsh():
    ...
    with open(".temp2",'r') as temp_f2, open(out_file,'w') as out_f:
        ...
        out_f.write("# Decrypted by Jarz | FUSCATOR\n# Github- https://github.com/salampahah\n\n"+filedata)
    os.remove(".temp2")
    sprint(f"{success}{out_file} saved in {pwd}")
    mover(out_file)
